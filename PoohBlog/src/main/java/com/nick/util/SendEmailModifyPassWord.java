...
public class SendEmailModifyPassWord {
    public static void snedEmail(String code,String mail) throws Exception {
        ...
        //邮件文本内容
        message.setContent("<a href='http://localhost:8080/user/verification/modifyPassWord/"+mail+"/"+code+"'>click me<a/>","text/html;charset=UTF-8");
        //指明邮件发件人
